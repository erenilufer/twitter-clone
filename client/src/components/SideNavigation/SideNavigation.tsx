...
const SideNavigation = (props: Props) => {
  return (
    <div className="text-[#f7f9f9]">
      ...
      <div className="sideNav flex flex-col gap-2 mb-4">
        <div className=" sideitem flex  gap-3 hover:bg-[#404951] duration-200 cursor-pointer  p-2 px-3 rounded-3xl">
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
            fill="#f7f9f9"
      ...
      <div className="p-3 bg-[#1d9bf0] hover:bg-[#1a8cd8] duration-200 rounded-full cursor-pointer ">
        <h1 className="text-center font-semibold text-sm ">Tweet</h1>
      </div>
    </div>
  );
};
